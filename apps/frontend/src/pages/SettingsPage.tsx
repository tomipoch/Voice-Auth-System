...
import DatasetRecordingSettings from '../components/settings/DatasetRecordingSettings';
  ...
  return (
    <MainLayout>
      ...
      <div className="space-y-6">
        ...
        {/* Dataset Recording - Superadmin Only */}
        {user?.role === 'superadmin' && <DatasetRecordingSettings className="p-6" />}
      </div>
    </MainLayout>
  );
};
