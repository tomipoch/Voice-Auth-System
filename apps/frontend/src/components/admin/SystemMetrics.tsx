import { Activity, Users, Shield, AlertTriangle, Clock, CheckCircle, XCircle } from 'lucide-react';
import Card from '../ui/Card';
import StatusIndicator from '../ui/StatusIndicator';
import { StatusType } from '../ui/StatusIndicator';
...
const SystemMetrics = ({ metrics = {}, isLoading = false }: SystemMetricsProps) => {
  const {
    totalUsers = 0,
    enrolledUsers = 0,
  ...
  const getHealthStatus = (health: string): StatusType => {
    switch (health) {
      case 'healthy':
        return 'success';
      case 'warning':
