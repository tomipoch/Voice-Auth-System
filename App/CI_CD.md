...
Deployments automáticos basados en branches y tags.
...
**Resultado:** Deploy automático a `dev.voiceauth.example.com`
...
**Resultado:** Deploy automático a `staging.voiceauth.example.com`
...
- Limitar retención de artefactos
- Configurar timeouts
...
GitHub → Actions tab → Ver todos los workflows

### Métricas

- ⏱️ Tiempo promedio de CI: ~2-3 minutos
- ✅ Success rate objetivo: >95%
- 📦 Deployments/día: Variable según actividad

---

**Pipeline configurado con ❤️ para deployments confiables**
