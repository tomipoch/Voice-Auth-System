...
export const mockApiService = {
  ...
  enrollment: {
    ...
    submitAudio: async (enrollmentId, audioBlob, phraseText) => {
      ...
      console.log('Processing audio for enrollment:', {
        enrollmentId,
  ...
  verification: {
    ...
    verifyAudio: async (verificationId, audioBlob, phraseText) => {
      // audioBlob y phraseText serán usados en la implementación real
      console.log('Processing audio for verification:', {
        verificationId,
        audioSize: audioBlob?.size,
        phrase: phraseText,
      });
      ...
      return {
        ...
        success,
        confidence_score,
        message: success ? 'Verificación exitosa' : 'Verificación fallida - intenta nuevamente',
        threshold: 0.75,
      };
    },
  },
