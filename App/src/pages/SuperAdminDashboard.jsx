...
const SuperAdminDashboard = () => {
  ...
  const superAdminStats = [
    ...
    },
    {
      ...
      value: isLoading ? '...' : systemStats?.verifications_today?.toString() || '0',
      icon: Shield,
      ...
      <div className="fixed inset-y-0 left-0 z-50 w-64 backdrop-blur-xl bg-white dark:bg-gray-900/70 border-r border-purple-200/40 shadow-xl">
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center px-6 py-4 border-b border-purple-200/30">
            ...
            <h1 className="ml-3 text-xl font-bold bg-gradient-to-r from-gray-800 to-purple-700 bg-clip-text text-transparent">
              Super Admin
            </h1>
          </div>
          ...
          <div className="px-6 py-4 border-b border-purple-200/30">
            <div className="flex items-center">
              <div className="h-12 w-12 bg-gradient-to-br from-purple-100 to-indigo-100 rounded-xl flex items-center justify-center shadow-sm border border-purple-200/40">
              ...
              <div className="ml-3">
                ...
                <span className="inline-block text-xs px-2 py-1 rounded-md mt-1 bg-red-100 text-red-700 border border-red-200">
                  Super Administrador
                </span>
              </div>
            </div>
          ...
          {/* Logout */}
          <div className="px-4 py-4 border-t border-purple-200/30">
            <Button
              onClick={handleLogout}
              variant="outline"
              className="w-full flex items-center justify-center border-purple-200/40 text-purple-700 hover:bg-purple-50/60"
            >
      ...
      <div className="ml-64 relative z-10">
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-800 to-purple-700 bg-clip-text text-transparent">
                Panel de Super Administrador
              </h1>
              <p className="text-purple-600/70 mt-2">Gestión global del sistema VoiceAuth</p>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <p className="text-sm font-medium text-gray-800">Sistema Global</p>
                <p className="text-xs text-purple-600">Acceso Completo</p>
              </div>
            </div>
          </div>
