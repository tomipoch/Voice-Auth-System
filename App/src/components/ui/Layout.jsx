...
const Layout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'Registro de Voz', href: '/enrollment', icon: UserPlus },
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <div className="flex items-center">
                ...
                <h1 className="ml-3 text-xl font-semibold text-gray-900">VoiceBio</h1>
              </div>
            </div>
      ...
      <div className="md:pl-64 flex flex-col flex-1">
        ...
        <div className="sticky top-0 z-10 md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-gray-50">
          <button
            type="button"
            className="-ml-0.5 -mt-0.5 h-12 w-12 inline-flex items-center justify-center rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
