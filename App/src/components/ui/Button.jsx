...
const Button = ({ 
  ...
  const variantClasses = {
    ...
    secondary: 'text-gray-800 bg-white/80 border border-blue-200/50 hover:bg-white/90 hover:border-blue-300/60 focus:ring-blue-300/50 shadow-sm hover:shadow-md backdrop-blur-xl',
    ...
    glass: 'text-gray-800 bg-white/60 border border-blue-200/40 hover:bg-white/70 hover:border-blue-300/50 focus:ring-blue-300/50 shadow-xl hover:shadow-2xl backdrop-blur-xl',
  };
