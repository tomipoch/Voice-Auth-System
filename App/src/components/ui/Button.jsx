...
const Button = ({
  ...
  const variantClasses = {
    primary:
      'text-white bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 focus:ring-blue-500/50 shadow-lg hover:shadow-xl',
    secondary:
    ...
    success:
      'text-white bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-400 hover:to-green-500 focus:ring-emerald-500/50 shadow-lg hover:shadow-xl',
    danger:
      'text-white bg-gradient-to-r from-red-500 to-red-600 hover:from-red-400 hover:to-red-500 focus:ring-red-500/50 shadow-lg hover:shadow-xl',
    warning:
      'text-white bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 focus:ring-amber-500/50 shadow-lg hover:shadow-xl',
    glass:
      'text-gray-800 dark:text-gray-200 bg-white dark:bg-gray-900/60 dark:bg-gray-800/60 border border-blue-200/40 dark:border-gray-600/40 hover:bg-white dark:bg-gray-900/70 dark:hover:bg-gray-800/70 hover:border-blue-300/50 dark:hover:border-gray-500/50 focus:ring-blue-300/50 dark:focus:ring-gray-500/50 shadow-xl hover:shadow-2xl backdrop-blur-xl',
  };
