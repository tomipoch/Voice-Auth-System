    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4 sm:p-6">
        ...
        >
          ...
          <div 
            className="relative overflow-hidden rounded-3xl shadow-2xl bg-white/95 dark:bg-gray-800/95"
            style={{
          ...
          >
            ...
            {title && (
              <div className="relative flex items-center justify-between p-6 border-b border-white/20 dark:border-gray-600/20">
                ...
                <button
                  onClick={onClose}
                  className="group relative p-2 hover:bg-white/20 dark:hover:bg-gray-700/20 rounded-xl transition-all duration-200 backdrop-blur-sm"
                >
                  ...
                  <div className="absolute inset-0 rounded-xl bg-white/10 dark:bg-gray-700/10 opacity-0 group-hover:opacity-100 transition-opacity" />
                </button>
              </div>
            )}
            
            {/* Content con padding mejorado */}
            <div className={`relative ${title ? "p-6" : "p-8"}`}>
              {children}
            </div>
          </div>
        </div>
