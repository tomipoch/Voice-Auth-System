import { Mic, Clock, Volume2, ShieldCheck, ArrowRight } from 'lucide-react';
...
const VerificationWelcomeScreen = ({ onStart, className = '' }: VerificationWelcomeScreenProps) => {
  const recommendations = [
    ...
    },
    {
      ...
      description: 'Usa el mismo micrófono que en el registro si es posible',
    },
    {
      icon: ShieldCheck,
      title: 'Seguridad',
      description: 'Proceso seguro y encriptado',
    },
    {
      icon: Clock,
      title: 'Tiempo Estimado',
      description: '10-15 segundos para verificar',
    },
  ];
    ...
    <div className={`max-w-4xl mx-auto ${className}`}>
      ...
      <Card variant="glass" className="p-8 mb-6 text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
          Vamos a verificar tu identidad usando tu voz. Solo necesitas leer{' '}
          <span className="font-semibold text-blue-600 dark:text-blue-400">una frase</span> de forma
          clara y natural.
        </p>

        <div className="flex items-center justify-center space-x-2 text-sm text-blue-600/70 dark:text-blue-400/70">
          <Clock className="h-4 w-4" />
          <span className="font-medium">Tiempo estimado: 15 segundos</span>
        </div>
      </Card>
...
export default VerificationWelcomeScreen;
